...
- [x] All dependencies install correctly via `pip install -r requirements.txt`
- [x] Model imports work without errors
- [x] A minimal training run can be started (may require data preparation first)
- [x] CLAUDE.md accurately reflects the project structure
